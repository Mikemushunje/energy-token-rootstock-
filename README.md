...
Here is the content for your README.md file, taken directly from the document you provided earlier.
README.md
# EnergyToken: Tokenized Energy Microgrid Payments on Rootstock
...
└── simulateMeter.js
/diagrams
└── energy-flow.png  (You'll add this manually)
.env
.env.example
README.md
package.json
...
Summary of Console Interactions:
| Function | Command | Output |
|---|---|---|
| mint() | await token.mint(address, amount) | MetaMask confirmation + updated balance |
| burn() | await token.burn(address, amount) | Reduced balance |
| balanceOf() | ethers.utils.formatEther(await token.balanceOf(address)) | Real-time balance in console |
